...
public class Customer {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Organization VAT ID. Only applies for b2b orders.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, gender, dateOfBirth, organizationRegistrationId, vatId, additionalProperties);
  }
